...
Answer: variable names are different. one had numbers starting w/ 0 and the other doesn't

```{r}

#copy stfips data to create new column in percent_completed_by_state df called state_flips forcing values to be 2 digits (start w/ 0)
